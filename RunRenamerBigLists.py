...
wkd_emuimu_ew = ['AA','AB','AC','AD','AE','AF','AG','AH','AI','AJ','AK','AL','AM','AN','AO','AP','AQ','AR','AS','AT','AU','AV','AW','AX','AY','AZ',
...
sat_emuimu_ew = ['IA','IB','IC','ID','IE','IF','IG','IH','II','IJ','IK','IL','IM','IN','IO','IP','IQ','IR','IS','IT','IU','IV','IW','IX','IY','IZ',
...
sun_emuimu_ew = ['OA','OB','OC','OD','OE','OF','OG','OH','OI','OJ','OK','OL','OM','ON','OO','OP','OQ','OR','OS','OT','OU','OV','OW','OX','OY','OZ',
...
try:
    ...
    for k,v in run_dict.items():
        ...
        if DoO == '120': 
            if unittyp in ['EMU','SMU','IMU100']:
                mth_emuimu.append((run,DoO))
            if unittyp == 'NGR':
    ...
    reassign_runs(mth_emuimu, wkd_emuimu_ew)
    reassign_runs(fri_emuimu, wkd_emuimu_ew)
    reassign_runs(sat_emuimu, sat_emuimu_ew)
    reassign_runs(sun_emuimu, sun_emuimu_ew)
