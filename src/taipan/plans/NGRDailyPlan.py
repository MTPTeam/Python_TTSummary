...
def NGR_DPP(path, path_char, mypath = None):
    ...
    try:
        ...
        def fill_formula(start_row, end_row, column, formula, sheet):
        ...
        for row,x in enumerate(nurseryruns,2):
            ...
            # KM formula template
            # formula_th = "=XLOOKUP(1,('KM by Service'!$A$2:$A$10000='Deployment Plan'!BROW_NUM)*('KM by Service'!$B$2:$B$10000='Deployment Plan'!CROW_NUM),'KM by Service'!$C$2:$C$10000)"
            # formula_fr = "=XLOOKUP(1,('KM by Service'!$A$2:$A$10000='Deployment Plan'!NROW_NUM)*('KM by Service'!$B$2:$B$10000='Deployment Plan'!OROW_NUM),'KM by Service'!$C$2:$C$10000)"
            # formula_sa = "=XLOOKUP(1,('KM by Service'!$A$2:$A$10000='Deployment Plan'!ZROW_NUM)*('KM by Service'!$B$2:$B$10000='Deployment Plan'!AAROW_NUM),'KM by Service'!$C$2:$C$10000)"
            # formula_su = "=XLOOKUP(1,('KM by Service'!$A$2:$A$10000='Deployment Plan'!ALROW_NUM)*('KM by Service'!$B$2:$B$10000='Deployment Plan'!AMROW_NUM),'KM by Service'!$C$2:$C$10000)"
            ...
            #     if ('thurs_run' in globals() or 'thurs_run' in locals()):
            ...
            #     if ('fri_run' in globals() or 'fri_run' in locals()):
            #         if x[0] == fri_run[0][0]:
            ...
            #     if ('sat_run' in globals() or 'sat_run' in locals()):
            #         if x[0] == sat_run[0][0]:
            ...
            #     if ('sun_run' in globals() or 'sun_run' in locals()):
            #         if x[0] == sun_run[0][0]:
            ...
            if row != 2 and x[0] != nurseryruns[row-3][0]:
                ...
                if ('thurs_run' in globals() or 'thurs_run' in locals()) and ('fri_run' in globals() or 'fri_run' in locals()) and ('sat_run' in globals() or 'sat_run' in locals()) and ('sun_run' in globals() or 'sun_run' in locals()):
                ...
                elif ('thurs_run' in globals() or 'thurs_run' in locals()) and ('fri_run' in globals() or 'fri_run' in locals()) and ('sat_run' in globals() or 'sat_run' in locals()):    
                    if nurseryruns[row-3][0] == thurs_run[0][0] == fri_run[0][0] == sat_run[0][0]:
                        km_summ(run_row,0,'B',thrun_formula,blue_subhead)
                        km_summ(run_row,3,'E',frrun_formula,red_subhead)
                        km_summ(run_row,6,'H',sarun_formula,green_subhead)
                ...
                elif ('thurs_run' in globals() or 'thurs_run' in locals()) and ('fri_run' in globals() or 'fri_run' in locals()) and ('sun_run' in globals() or 'sun_run' in locals()):            
                    if nurseryruns[row-3][0] == thurs_run[0][0] == fri_run[0][0] == sun_run[0][0]:
                        km_summ(run_row,0,'B',thrun_formula,blue_subhead)
                        km_summ(run_row,3,'E',frrun_formula,red_subhead)
                        km_summ(run_row,9,'K',surun_formula,orange_subhead)
                ...
                elif ('thurs_run' in globals() or 'thurs_run' in locals()) and ('fri_run' in globals() or 'fri_run' in locals()):            
                    if nurseryruns[row-3][0] == thurs_run[0][0] == fri_run[0][0]:
                        km_summ(run_row,0,'B',thrun_formula,blue_subhead)
                        km_summ(run_row,3,'E',frrun_formula,red_subhead)
                ...
                elif ('sat_run' in globals() or 'sat_run' in locals()) and ('sun_run' in globals() or 'sun_run' in locals()):            
                    if nurseryruns[row-3][0] == sat_run[0][0] == sun_run[0][0]:
                        km_summ(run_row,6,'H',sarun_formula,green_subhead)
                        km_summ(run_row,9,'K',surun_formula,orange_subhead)
                ...
                elif ('sun_run' in globals() or 'sun_run' in locals()):            
                    if nurseryruns[row-3][0] == sun_run[0][0]:
                        km_summ(run_row,9,'K',surun_formula,orange_subhead)
                ...
                elif ('sat_run' in globals() or 'sat_run' in locals()):            
                    if nurseryruns[row-3][0] == sat_run[0][0]:
                        km_summ(run_row,6,'H',sarun_formula,green_subhead)
                ...
                elif ('thurs_run' in globals() or 'thurs_run' in locals()):                
                    if nurseryruns[row-3][0] == thurs_run[0][0]:
                        km_summ(run_row,0,'B',thrun_formula,blue_subhead)
        ...
        if is_file_open(filename_xlsx):  # Check if the file is open
            show_info("Error", "The workbook is already open. Please close it before proceeding.")
...
def run_ngr_dpp(path=None, path_char=None):
